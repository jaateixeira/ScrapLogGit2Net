...
printf "%s" "${BLUE}Do you want to extract yearly networks? (y/n): ${NC}"
...
exit 
    ...
    printf "%s" "${YELLOW}This will create ${total_years} yearly files. Continue? (y/n): ${NC}"
    read confirmation
