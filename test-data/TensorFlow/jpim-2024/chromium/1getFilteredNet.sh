...
CMD="../../../../formatFilterAndViz-nofi-GraphML.py  $INPUT -pl   -oi gmail,ee,hotmail,outlook,yahoo,qq,users,163,gmx  -oo $TOP10_ORG  --legend_type=top10+1 --org_list_and_neighbours_only chromium --legend_extra_organizations $FOCAL_ORG --save_graphML" 
